...
public class CONTMX_Reporteiva extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strcContmxReporteietuId = vars.getSessionValue("CONTMX_Reporteiva.inpContmxReporteivaId_R");

      if (strcContmxReporteietuId.equals(""))
        strcContmxReporteietuId = vars.getSessionValue("CONTMX_Reporteiva.inpContmxReporteivaId");
  ...
  private void printPagePartePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: CONTMX_Reporteiva - pdf");
    ...
    response.setHeader("Content-disposition", "inline; filename=CONTMX_Reporteiva.pdf");
    String strReportName = "@basedesign@/com/tegik/contmx/modulo/erpCommon/ad_reports/CONTMX_ReporteivaJR.jrxml";
