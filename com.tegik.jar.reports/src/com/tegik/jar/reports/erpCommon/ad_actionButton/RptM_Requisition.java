 ...
 ************************************************************************
 */
package com.tegik.jar.reports.erpCommon.ad_actionButton;
...
public class RptM_Requisition extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strmRequisitionId = vars.getSessionValue("RptMRequisition.inpmRequisitionId_R");
      if (strmRequisitionId.equals(""))
        strmRequisitionId = vars.getSessionValue("RptMRequisition.inpmRequisitionId");
  ...
  private void printPagePartePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      JasperDesign jasperDesignLines = JRXmlLoader.load(strBaseDesign
          + "/com/tegik/jar/reports/erpCommon/ad_actionButton/RptM_Requisition_Lines.jrxml");
