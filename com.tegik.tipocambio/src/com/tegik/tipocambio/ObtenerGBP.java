...
public class ObtenerGBP extends DalBaseProcess {

  static int counter = 0;

  private ProcessLogger logger;
  private static final Logger log = Logger.getLogger(ObtenerGBP.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      Currency monedaMeta = Finder.findCurrencyByISOCode("GBP");
