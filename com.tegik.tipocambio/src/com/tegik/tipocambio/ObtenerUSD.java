...
public class ObtenerUSD extends DalBaseProcess {

  static int counter = 0;

  private ProcessLogger logger;
  private static final Logger log = Logger.getLogger(ObtenerUSD.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      Currency monedaMeta = Finder.findCurrencyByISOCode("USD");
