...
public class ObtenerJPY extends DalBaseProcess {

  static int counter = 0;

  private ProcessLogger logger;
  private static final Logger log = Logger.getLogger(ObtenerJPY.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      Currency monedaMeta = Finder.findCurrencyByISOCode("JPY");
